let handler  = async (m, { conn, text, command, args, usedPrefix }) => {
       ...
       let pancingan = pengguna.pancing
       let pemancing = pengguna.name
       let umpan = pengguna.umpan
       let type = (args[0] || '').toLowerCase()
       
let ages = `Contoh penggunaan: *.mancing emosi*
...
//
	...
	case 'emosi':
	let __timers = (new Date - pengguna.lastmancing)
    ...
    if (pengguna.lastmancing > 60000) throw m.reply(`Kamu masih kelelahan\nHarap tunggu *${timers}* lagi`)
    
        if (pengguna.pancing > 0 ) {
        if (new Date - pengguna.lastmancing > 60000) {
...
Kamu bisa memasak ini atau menjualnya.
_example:_
◉ *${ usedPrefix }cook*
◉ *${ usedPrefix }pasar*`    
        setTimeout(() => {
        conn.sendFile(m.chat, 'https://cdn.jsdelivr.net/gh/SazumiVicky/MakeMeow-Storage@main/mancing.jpg', 'ages.jpg', mcng, m)
         if (psepick > 0 ) {
       ...
       setTimeout(() => {
        ...
        pengguna.nila += nila * 1
         ...
         pengguna.lastmancing += new Date * 1
         ...
         pengguna.kepiting += kepiting * 1
           ...
           break
	          ...
	          case 'easy':
                                  ...
                                  if (new Date - pengguna.lastmancingeasy > 3600000) {
                                  if (pengguna.pancing > 1) {
                                 ...
                                 let hsl = `*Hasil 🎣Memancing ${pemancing}*
...
`.trim()
	          ...
	          case 'normal':
                                  ...
                                  if (pancingan == 0 || umpan == 0) return conn.reply(m.chat, `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`, m)
                                  if (new Date - pengguna.lastmancingnormal > 3600000) {
                                  if (pengguna.pancing > 2) {
                                 ...
                                 let hsls = `*Hasil 🎣Memancing ${pemancing}*
...
`.trim()
                                ...
                                conn.reply(m.chat, `${pemancing} Menunggu`, m)
                                 ...
                                 pengguna.lastmancingnormal = new Date * 1
	          ...
	          case 'hard':
                                  ...
                                  let _timerh = (86400000 - __timerh)
                                  let timerh = clockString(_timerh) 
                                  if (pancingan == 0 || umpan == 0) return conn.reply(m.chat, `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`, m)
                                  if (new Date - pengguna.lastmancinghard > 86400000) {
                                  if (pengguna.pancing > 3) {
                                 ...
                                 let hslsh = `*Hasil 🎣Memancing ${pemancing}*
...
`.trim()
                                ...
                                conn.reply(m.chat, `${pemancing} Menunggu`, m)
                                 ...
                                 pengguna.lastmancinghard = new Date * 1
	          ...
	          case 'extreme':
                                  ...
                                  let _timere = (86400000 - __timere)
                                  let timere = clockString(_timere) 
                                  if (pancingan == 0 || umpan == 0) return conn.reply(m.chat, `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`, m)
                                  if (new Date - pengguna.lastmancingextreme > 86400000) {
                                  if (pengguna.pancing > 4) {
                                 ...
                                 let hslse = `*Hasil Memancing ${pemancing}*
 *🦀 = [ ${ainese2} ]*			
 *🐠 = [ ${ainese6} ]*
 *🦞 = [ ${ainese8} ]*			 
 *🐟 = [ ${ainese11} ]*
...
`.trim()
                                ...
                                conn.reply(m.chat, `${pemancing} Menunggu`, m)
                                 ...
                                 pengguna.lastmancingextreme = new Date * 1
...
handler.tags = ['rpg']
handler.command = /^(fishing|mancing|agesu)$/i
