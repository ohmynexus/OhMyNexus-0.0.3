...
let nomors = m.sender
  ...
  if (!who) throw 'Tag salah satu yang ingin kamu rampok.'
  ...
  if (10000 > users[who].balance) throw 'Target yang kamu tag tidak mempunyai uang.'
  users[who].balance -= dapat * 1
  users[m.sender].balance += dapat * 1
  global.db.data.users[m.sender].lastrob = new Date * 1
  conn.reply(m.chat, `Berhasil Merampok balance Target Sebesar ${dapat}`, m)
